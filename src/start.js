...
function start(container) {
  ...
  addProjectBtn.setAttribute('class', 'btn text-center  mt-5 mx-auto text-white bg-primary add-project');
  ...
  addTaskBtn.setAttribute('class', 'btn mt-2 ml-5 text-white bg-primary add-task');
